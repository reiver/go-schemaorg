...
var _ ProtoThing = DataFeed{}

func (receiver DataFeed) ProtoThing() AnyThing {
	const thingType string = TypeDataFeed
...
var _ ProtoCreativeWork = DataFeed{}
...
func (receiver DataFeed) ProtoDataset() AnyDataset {
	...
	return AnyDataset{
		...
		IncludedInDataCatalog:     receiver.IncludedInDataCatalog,
		ISSN:                      receiver.ISSN,
		MeasurementMethod:         receiver.MeasurementMethod,
		MeasurementTechnique:      receiver.MeasurementTechnique,
		VariableMeasured:          receiver.VariableMeasured,
	}
}

var _ ProtoDataFeed = DataFeed{}
...
func (receiver DataFeed) ProtoDataFeed() AnyDataFeed {
	...
	return AnyDataFeed{
		...
		DataFeedElement:           receiver.DataFeedElement,
	}
}
