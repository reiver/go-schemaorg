...
type AnyCreativeWork struct {
	...
	MainEntityOfPage               []ProtoThing `json:"mainEntityOfPage,omitempty"`          // https://schema.org/mainEntityOfPage
	...
	MainEntity                []Question           `json:"mainEntity,omitempty"`                // https://schema.org/mainEntity
