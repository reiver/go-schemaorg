...
var _ ProtoThing = Answer{}

func (receiver Answer) ProtoThing() AnyThing {
	const thingType string = TypeAnswer
...
var _ ProtoCreativeWork = Answer{}
...
func (receiver Answer) ProtoComment() AnyComment {
	...
	return AnyComment{
		...
		DownvoteCount:             receiver.DownvoteCount,
		ParentItem:                receiver.ParentItem,
		SharedContent:             receiver.SharedContent,
		UpvoteCount:               receiver.UpvoteCount,
	}
}
